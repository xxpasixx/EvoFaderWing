...
#define SLOW_ZONE        20      // OSC units - start slowing earlier for smoother approach
#define FAST_ZONE        50      // OSC units - when to use full speed
...
#define EXECUTOR_BASE_BRIGHTNESS 10   // Populated but off
#define EXECUTOR_ACTIVE_BRIGHTNESS 80 // Populated and on (unpopulated stays dark)
